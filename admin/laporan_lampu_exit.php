...
$st = mysqli_prepare(
    $koneksi,
    "SELECT MONTH(tanggal_cek) as bln, COUNT(*) as total
     FROM `inspeksi_lampu_exit`
     WHERE YEAR(tanggal_cek) = ?
     GROUP BY MONTH(tanggal_cek)"
);
...
<head>
    ...
    <title>Laporan Inspeksi Lampu Exit</title>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            <div class="laporan-header">
                <div class="lh-icon"><i class="fa-solid fa-door-open"></i></div>
                <div>
                    <h2>Laporan Inspeksi Lampu Exit</h2>
                    <p>Klik bulan untuk melihat data hasil inspeksi Lampu Exit</p>
                </div>
            </div>

            <div class="year-nav">
                <a href="laporan_lampu_exit.php?tahun=<?= $tahun_aktif - 1; ?>" class="btn-year">
            ...
            <div class="month-grid">
                <?php for ($b = 1; $b <= 12; $b++):
                    ...
                    $has   = $total > 0;
                    $url   = "data_inspeksi_lampu_exit.php?bulan=" . $nama_bulan[$b] . "&tahun=" . $tahun_aktif;
                ?>
