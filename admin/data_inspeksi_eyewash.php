...
if (isset($_GET['hapus']) && is_numeric($_GET['hapus'])) {
    $id   = (int)$_GET['hapus'];
    $stmt = mysqli_prepare($koneksi, "DELETE FROM `inspeksi_eyewash` WHERE `id_inspeksi` = ?");
    mysqli_stmt_bind_param($stmt, "i", $id);
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    header("Location: data_inspeksi_eyewash.php?bulan=" . urlencode($bulan) . "&tahun=$tahun&msg=hapus");
    exit();
}
...
<head>
    ...
    <title>Laporan Eye Wash - <?= $bulan_indo . ' ' . $tahun; ?></title>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="has-submenu active">
                ...
                <ul class="submenu" style="display: block;">
                    ...
                    <li class="active"><a href="laporan_eyewash.php"> Eye Wash</a></li>
                </ul>
            </li>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            ...
            <div class="page-head">
                ...
                <div class="ph-info">
                    <h2>Laporan Inspeksi Eye Wash</h2>
            ...
            <div class="stats-row">
                <div class="s-card">
                    <div class="s-icon" style="background:#3b82f6"><i class="fa-solid fa-list-check"></i></div>
                    <div class="s-info">
                        <h4>Total Data</h4>
                        <p><?= $total; ?></p>
                    </div>
            ...
            <div class="action-bar">
                <div class="ab-left">
                    <a href="laporan_eyewash.php?tahun=<?= $tahun; ?>" class="btn btn-back">
                        <i class="fa-solid fa-arrow-left"></i> Kembali
                    </a>
                    <a href="data_inspeksi_eyewash.php?bulan=<?= urlencode($bulan); ?>&tahun=<?= $tahun; ?>&cari=<?= urlencode($cari); ?>&export=excel" class="btn btn-excel">
                ...
                <div class="ab-right">
                    <form method="GET" class="search-wrap">
                        ...
                        <?php if ($cari !== ''): ?>
                            <a href="data_inspeksi_eyewash.php?bulan=<?= urlencode($bulan); ?>&tahun=<?= $tahun; ?>" class="btn btn-reset"><i class="fa-solid fa-xmark"></i></a>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
