...
if (isset($_POST['tambah_line'])) {
    ...
    header("Location: area_line_eyewash.php?msg=tambah");
    exit();
}
...
if (isset($_POST['edit_line'])) {
    ...
    $nama = trim($_POST['nama_line']);
    $stmt = mysqli_prepare($koneksi, "UPDATE area_line SET nama_line = ? WHERE id_line = ? AND jenis = 'eyewash'");
    mysqli_stmt_bind_param($stmt, "si", $nama, $id);
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    header("Location: area_line_eyewash.php?msg=edit");
    exit();
}
...
if (isset($_GET['hapus'])) {
    ...
    $cek = mysqli_query(
        $koneksi,
        "SELECT COUNT(*) as total FROM `master_eyewash`
         WHERE `line_area` = (SELECT nama_line FROM area_line WHERE id_line = $id)"
    );
    $row_cek = mysqli_fetch_assoc($cek);
    if ($row_cek['total'] > 0) {
        header("Location: area_line_eyewash.php?msg=gagal_hapus");
    } else {
        $stmt = mysqli_prepare($koneksi, "DELETE FROM area_line WHERE id_line = ? AND jenis = 'eyewash'");
        mysqli_stmt_bind_param($stmt, "i", $id);
        mysqli_stmt_execute($stmt);
        mysqli_stmt_close($stmt);
        header("Location: area_line_eyewash.php?msg=hapus");
    }
    exit();
}
...
if ($cari !== '') {
    ...
    $stmt = mysqli_prepare(
        ...
        "SELECT a.*, COUNT(m.id) as total_item
         FROM area_line a
         LEFT JOIN `master_eyewash` m ON m.`line_area` = a.nama_line
         WHERE a.jenis = 'eyewash' AND a.nama_line LIKE ?
...
<head>
    ...
    <title>Area Line Eye Wash</title>
...
<body>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="has-submenu active">
                ...
                <ul class="submenu" style="display:block;">
                    ...
                    <li class="active"><a href="area_line_eyewash.php">Eye Wash</a></li>
                </ul>
            </li>
        ...
        <section class="content-body">
            ...
            <div class="page-toolbar">
                <form method="GET" class="search-bar">
                    ...
                    <?php if ($cari !== ''): ?>
                        <a href="area_line_eyewash.php" class="btn btn-outline"><i class="fa-solid fa-rotate-left"></i> Reset</a>
                    <?php endif; ?>
                </form>
                            ...
                            while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    ...
                                    <td class="action-icons">
                                        ...
                                        <a href="area_line_eyewash.php?hapus=<?= $row['id_line']; ?>" class="ic-delete" title="Hapus"
                        ...
                        <?php else: ?>
                            <tr class="empty-row">
                                <td colspan="5">
                                    ...
                                    Belum ada area line untuk Eye Wash.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <div class="modal-overlay" id="modalTambah">
        <div class="modal-box">
            <h3><i class="fa-solid fa-eye"></i> Tambah Area Line — Eye Wash</h3>
            <form method="POST">
                <div class="form-group">
                    ...
                    <p class="input-hint">Area ini khusus untuk Eye Wash.</p>
                </div>
        ...
        <div class="modal-box">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <p class="input-hint">Perubahan nama akan otomatis berlaku di data master Eye Wash.</p>
                </div>
                <div class="modal-footer">
