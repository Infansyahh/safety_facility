...
<head>
    ...
    <title>Laporan Inspeksi Eye Wash</title>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            <div class="laporan-header">
                <div class="lh-icon"><i class="fa-solid fa-eye"></i></div>
                <div>
                    <h2>Laporan Inspeksi Eye Wash</h2>
                    <p>Klik bulan untuk melihat data hasil inspeksi Eye Wash</p>
                </div>
            </div>

            <div class="year-nav">
                <a href="laporan_eyewash.php?tahun=<?= $tahun_aktif - 1; ?>" class="btn-year">
            ...
            <div class="month-grid">
                <?php for ($b = 1; $b <= 12; $b++):
                    ...
                    $has   = $total > 0;
                    $url   = "data_inspeksi_eyewash.php?bulan=" . $nama_bulan[$b] . "&tahun=" . $tahun_aktif;
                ?>
