...
if (isset($_GET['hapus']) && is_numeric($_GET['hapus'])) {
    $id   = (int)$_GET['hapus'];
    $stmt = mysqli_prepare($koneksi, "DELETE FROM `inspeksi_lampu_exit` WHERE `id_inspeksi` = ?");
    mysqli_stmt_bind_param($stmt, "i", $id);
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    header("Location: data_inspeksi_lampu_exit.php?bulan=" . urlencode($bulan) . "&tahun=$tahun&msg=hapus");
    exit();
}
...
<head>
    ...
    <title>Laporan Lampu Exit - <?= $bulan_indo . ' ' . $tahun; ?></title>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            ...
            <div class="page-head">
                ...
                <div class="ph-info">
                    <h2>Laporan Inspeksi Lampu Exit</h2>
            ...
            <div class="stats-row">
                <div class="s-card">
                    <div class="s-icon" style="background:#10b981"><i class="fa-solid fa-list-check"></i></div>
                    <div class="s-info">
                        <h4>Total Data</h4>
                        <p><?= $total; ?></p>
                    </div>
            ...
            <div class="action-bar">
                <div class="ab-left">
                    <a href="laporan_lampu_exit.php?tahun=<?= $tahun; ?>" class="btn btn-back">
                        <i class="fa-solid fa-arrow-left"></i> Kembali
                    </a>
                    <a href="data_inspeksi_lampu_exit.php?bulan=<?= urlencode($bulan); ?>&tahun=<?= $tahun; ?>&cari=<?= urlencode($cari); ?>&export=excel"
                        class="btn btn-excel">
                ...
                <div class="ab-right">
                    <form method="GET" class="search-wrap">
                        ...
                        <?php if ($cari !== ''): ?>
                            <a href="data_inspeksi_lampu_exit.php?bulan=<?= urlencode($bulan); ?>&tahun=<?= $tahun; ?>"
                        ...
                        <?php if ($total > 0): ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="td-date"><?= date('d-m-Y H:i', strtotime($vals[2])); ?></td>
                                    <?php
                                    ...
                                    endforeach; ?>
                                    <td>
                                        <a href="data_inspeksi_lampu_exit.php?bulan=<?= urlencode($bulan); ?>&tahun=<?= $tahun; ?>&cari=<?= urlencode($cari); ?>&hapus=<?= $id_rec; ?>"
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p>Tidak ada data inspeksi Lampu Exit untuk <?= $bulan_indo . " " . $tahun; ?></p>
                                        <?php if ($cari !== ''): ?>
