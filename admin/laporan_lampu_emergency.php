...
<head>
    ...
    <title>Laporan Inspeksi Lampu Emergency</title>
    ...
    <main class="main-content">
        ...
        <section class="content-body">
            <div class="laporan-header">
                <div class="lh-icon"><i class="fa-solid fa-bolt"></i></div>
                <div>
                    <h2>Laporan Inspeksi Lampu Emergency</h2>
                    <p>Klik bulan untuk melihat data hasil inspeksi Lampu Emergency</p>
                </div>
            </div>

            <div class="year-nav">
                <a href="laporan_lampu_emergency.php?tahun=<?= $tahun_aktif - 1; ?>" class="btn-year">
            ...
            <div class="month-grid">
                <?php for ($b = 1; $b <= 12; $b++):
                    ...
                    $has   = $total > 0;
                    $url   = "data_inspeksi_lampu_emergency.php?bulan=" . $nama_bulan[$b] . "&tahun=" . $tahun_aktif;
                ?>
