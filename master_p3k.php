    ...
    <main class="main-content">
        ...
        <section class="content-body">
            ...
            <div class="top-actions">
                <button type="button" id="btnCetakTerpilih" onclick="cetakBarcodeTerpilih('p3k')" style="background: #6f42c1; border:none; padding:10px 15px; margin-bottom: 10px; color:white; border-radius:5px; cursor:pointer;"><i class="fa-solid fa-print"></i> Cetak Barcode Terpilih</button>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="width: 3%"><input type="checkbox" id="checkAll" onclick="toggleCheckAll(this)"></th><th style="width: 5%">No</th>
                            <th>Inspektor</th>
                            <th>Kode</th>
                            <th>Departemen</th>
                            <th>Lokasi</th>
                    ...
                    <tbody>
                        ...
                        <?php }
                            ...
                            echo "<tr><td colspan='11' style='text-align:center;'>Tidak ada data master tersedia</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
