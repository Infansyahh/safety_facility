    ...
    <main class="main-content">
        ...
        <section class="content-body">
            ...
            <div class="top-actions">
                <button type="button" id="btnCetakTerpilih" onclick="cetakBarcodeTerpilih('eyewash')" style="background: #6f42c1; border:none; padding:10px 15px; margin-bottom: 10px; color:white; border-radius:5px; cursor:pointer;"><i class="fa-solid fa-print"></i> Cetak Barcode Terpilih</button>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="width: 3%"><input type="checkbox" id="checkAll" onclick="toggleCheckAll(this)"></th><th style="width: 3%">No</th>
                            <th>Inspektor</th>
                            <th>Kode Eye Wash</th>
                            <th>Departemen</th>
                            <th>Lokasi</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td><input type="checkbox" class="row-check" value="<?= $safeId; ?>"></td>
                                    <td><?= $no++; ?></td>
